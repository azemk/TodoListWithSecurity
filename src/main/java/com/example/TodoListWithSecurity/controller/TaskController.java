...
public class TaskController {
    ...
    public String createTask(@ModelAttribute("newTask") Tasks tasks ,
                             Principal principal ,
    ...
    @GetMapping  ("/getTasks")
    public String getTasksForm(@NotNull Model model , Authentication authentication){
        List<Tasks> taskDto = taskService.findByUser(authentication.getName());
